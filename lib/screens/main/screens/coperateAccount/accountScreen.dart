...
class CorperateAccountScreen extends StatelessWidget {
  CorperateAccountScreen({Key? key}) : super(key: key);
                          ...
                          Flexible(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  _listTile(Iconsax.user, "Profile", (){Get.toNamed(coperateProfileScreen);}),
                                  const Divider(
                                  ...
                                  _listTile(Iconsax.car, "Vehicles", (){Get.toNamed(coperateVehicleScreen);}),
                                  const Divider(
                                    color: Color(0xffE8E9E8),
                                  ),
                                  _listTile(Iconsax.tag_user, "Drivers", (){Get.toNamed("");})
                                ],
                              ),
                            ),
                          )
