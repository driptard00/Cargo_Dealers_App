...
class ResetPinOtpScreen extends StatelessWidget {
  ResetPinOtpScreen({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('Verify your email',
                          ...
                          const Text(
                            'We will send a verification code akintade@gmail.com',
                            maxLines: 2,
                            style: TextStyle(
                        ...
                        Form(
                          ...
                          child: Padding(
                            ...
                            child: PinCodeTextField(
                              ...
                              errorTextSpace: 0.0,
                              showCursor: true,
                              cursorColor: const Color(0xFF85B870),
                              obscureText: true,
                              obscuringCharacter: '●',
                              pinTheme: PinTheme(
                                fieldHeight: 56.0,
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: (){
                          ...
                          Get.toNamed(resetPinInputScreen);
                        },
